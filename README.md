...
- [教程](#教程)
  - [油猴插件安装教程（免翻墙）（Tampermonkey-installation-tuterial）](#油猴插件安装教程免翻墙tampermonkey-installation-tuterial)
...
### [油猴插件安装教程（免翻墙）（Tampermonkey-installation-tuterial）]( https://blog.csdn.net/qq_42918883/article/details/115610486 )
...
- 编程
  - 教程
    ...
    - `WeChat Applet`：[微信开放文档]( https://developers.weixin.qq.com/miniprogram/dev/framework/ )
    - `Front End`：[Vue.js]( https://cn.vuejs.org/v2/guide/ )、[React]( https://react.docschina.org/docs/getting-started.html )
    - `Chrome Extensions`: [Extensions - Chrome Developers](https://developer.chrome.com/docs/extensions/)
    - `Machine Learning`: [Dive into Deep Learning]( http://d2l.ai/ )
  ...
  - 在线开发环境：[C语言开发环境]( https://clin.icourse163.org/ )、[菜鸟工具]( https://c.runoob.com/ )、[Data Science Workshop]( https://dsw-dev.data.aliyun.com/#/ )
  ...
  - 其他：[Unicode]( https://www.compart.com/en/unicode/ )、[站长工具]( https://seo.chinaz.com/ )
- 学习
  - 问答：[百度]( https://www.baidu.com/ )、[知乎]( https://www.zhihu.com/ )、[Bilibili]( https://www.bilibili.com/ )
...
- 设计
  ...
  - 配色：[520设计网]( https://www.sj520.cn/ )、[SpyColor]( https://zh.spycolor.com/ )
  - 字体：[艺术字体转换器]( http://www.akuziti.com/ )
  - 软件：[CorelDRAW]( https://www.coreldraw.com/cn/ )、[Adobe Illustrator]( https://www.adobe.com/cn/products/illustrator.html )
- 其他
  - 文件
    - 解压缩：[360压缩]( https://yasuo.360.cn/ )
    - 格式转换：[格式工厂]( http://www.pcgeshi.com/ )
  - 图片
    - 图片外链：[路过图床]( https://imgchr.com/ )
